...
if __name__ == "__main__":
    ...
    # 优化权重的范围
    space = [(0.01, 2.0) for _ in range(15)]  # 为每个流设置一个权重范围 [0.01, 2.0]
    # 使用高斯过程最小化来优化权重
    ...
    # 保存最优得分到 npy 文件
    np.save('predjb.npy', best_final_score.numpy())
    log.write('最优得分已保存到 pred_jb.npy')
    print('Done')
    log.close()  # 关闭日志文件
